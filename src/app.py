...
activities = {
    ...
    "Yoga Club": {
        "description": "Improve flexibility and wellness through guided yoga sessions",
    ...
    "Photography Club": {
        "description": "Learn photography fundamentals and work on creative photo projects",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
